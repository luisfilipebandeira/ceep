...
class NotaWebClient {
    ...
    suspend fun buscaTodas(): List<Nota>? {
         return  try {
            val notasRespostas = notaService.buscaTodas()
            return notasRespostas.map { notasResposta ->
                notasResposta.nota
            }
        } catch (e: Exception) {
    ...
    suspend fun salva(nota: Nota): Boolean {
        try {
            ...
            Log.e(TAG, "salva: falha ao salvar nota", e)
        }
        return false
    }
    ...
    suspend fun remove(id: String): Boolean {
        try {
            ...
            Log.e(TAG, "falha ao tentar remover nota",e)
        }
        return  false
    }
}